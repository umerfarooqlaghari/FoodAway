/**
 * Product categories for food, grocery, and supermarket items.
 * Keep in sync with ../shared/productCategories.js (Render deploys backend only).
 */
...
const CATEGORY_COLORS = {
  ...
  Desserts: '#EDE9FE',
  'Coffee & Tea': 'rgba(255, 92, 0, 0.1)',
  'Coffee & Drinks': 'rgba(255, 92, 0, 0.1)',
  Sandwiches: '#FEE2E2',
  Pizza: '#FEE2E2',
  Sushi: '#E0F2FE',
  Salads: '#D1FAE5',
